...
namespace CombatManager.WPF7
{
	...
	public partial class MonsterEditorWindow : Window
	{
		...
		public MonsterEditorWindow()
		{
			...
			AvailableSkillsList.SelectionChanged += new SelectionChangedEventHandler(AvailableSkillsList_SelectionChanged);
            var loaded = false;
        ...
        private void HDButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Roll = DieRoll.FromString(Monster.Hd),
                HasToughness = _Monster.HasFeat("Toughness"),
                HPstatmod = (int) (_Monster.Type != "undead" ? 
        ...
        private void AuraCheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
        	_Monster.Aura = null;
        }


        private void AttacksEditorButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void SkillDeleteButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void AvailableSkillsList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        	var skill = (string)AvailableSkillsList.SelectedValue;
			...
			else				
			{
                ...
                if (SkillSubtypeTextBox.Visibility == Visibility.Visible)
                {
        ...
        private void SpecialAbilityDeleteButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void AddSpecialAbilityButton_Click(object sender, RoutedEventArgs e)
        {
