...
namespace CombatManager.WPF7
{
    ...
    public partial class ConditionSelector : Window
    {
        ...
        private void ConditionFilterText_TextChanged(object sender, TextChangedEventArgs e)
        {
        ...
        private void Popup_PreviewDragEnter(object sender, DragEventArgs e)
        {
        }
            ...
            if (characters != null)
            {
                foreach (var ch in characters)
                {
                    ...
                    if (ac != null)
                    {
                        ...
                        if (RoundsRadioButton.IsChecked == true)
                        {
                            int val;
        ...
        private void ConditionsRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            UpdatePageSelection();
        }
    ...
    && AddToFavoritesButton != null)
        ...
        private void ConditionFilterText_KeyDown(object sender, KeyEventArgs e)
        {
        	if (e.Key == Key.Enter)
			{
				AddCurrentCondition();
        ...
        private void ConditionsListBox_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
        ...
        private void ConditionDurationText_TextChanged(object sender, TextChangedEventArgs e)
        {
            if (!loadedDuration)
            {
                loadedDuration = true;
        ...
        private void EditCustomCondition_Click(object sender, RoutedEventArgs e)
        {
             var c = (Condition)conditionView.CurrentItem;
             if (c != null)
             {
        ...
        private void NewCustomCondition_Click(object sender, RoutedEventArgs e)
        {
            var dlg = new CustomConditionDialog
            {
                Owner = this
