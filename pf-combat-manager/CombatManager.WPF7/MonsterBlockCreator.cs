...
namespace CombatManager.WPF7
{
    public class MonsterBlockCreator : BlockCreator
    {
        ...
        private void CreateTopSection(Monster monster, Character ch, List<Block> blocks)
        {
            ...
            topParagraph.Inlines.AddRange(CreateItemIfNotNull("Description: ", true, monster.DescriptionVisual, null, true));
        ...
        private List<Inline> CreateRulesLink(string text, string rule, string ruleType, string end)
        {
            ...
            if (text != null)
            {
                ...
                if (ruleObject != null)
                {
                    t = (ToolTip)Application.Current.MainWindow.FindResource("ObjectToolTip");
        ...
        private void CreateDefenseSection(Monster monster, List<Block> blocks)
        {
            ...
            defensesParagraph.Inlines.AddRange(CreateItemIfNotNull(" ", false, monster.AcMods, null, false));
            ...
            defensesParagraph.Inlines.AddRange(CreateItemIfNotNull("; ", false, monster.HpMods, null, false));
            defensesParagraph.Inlines.Add(new LineBreak());
            ...
            defensesParagraph.Inlines.AddRange(CreateItemIfNotNull("; ", true, monster.SaveMods, null, false));
            defensesParagraph.Inlines.Add(new LineBreak());
        ...
        private void CreateDescriptionSection(Monster monster, List<Block> blocks)
        {
            ...
            if (monster.DescriptionVisual != null && monster.DescriptionVisual.Length > 0)
            {
                ...
                descriptionParagraph.Inlines.Add(new Run(monster.DescriptionVisual));
