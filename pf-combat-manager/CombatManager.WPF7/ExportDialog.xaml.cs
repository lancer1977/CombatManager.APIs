...
namespace CombatManager.WPF7
{
    ...
    public partial class ExportDialog : Window
    {
        ...
        public ExportDialog(ExportData d)
        {
            ...
            {
                Filter = m => ((ExportItem)m).IsSelected
            };
        ...
        private void SelectAllMonstersCheckbox_Click(object sender, RoutedEventArgs e)
        {
		...
		private void SelectAllFeatsCheckbox_Click(object sender, RoutedEventArgs e)
		{
        ...
        class ExportItem : ReactiveObject
        {
