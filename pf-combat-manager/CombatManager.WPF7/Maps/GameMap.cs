...
{
    public class GameMap : ReactiveObject
    {
        ...
        public Point GridOrigin
        {
            get
            {
                ...
                var p = new Point
                {
                    X = cellOrigin.X - xDistance * CellSizeWidth,
                    Y = cellOrigin.Y - yDistance * CellSizeHeight
                };
        ...
        private void MarkerListChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (markers == null)
            {
                markers = new Dictionary<int, List<Marker>>();
        ...
        public int CellIndex(MapCell cell)
        {
        ...
        public List<Marker> GetMarkers(MapCell cell)
        {
        ...
        public bool CellHasMarkers(MapCell cell)
        {
        ...
        public class Marker  : ReactiveObject
        {
