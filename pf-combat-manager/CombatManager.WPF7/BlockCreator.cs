...
namespace CombatManager.WPF7
{
    public abstract class BlockCreator
    {
        ...
        protected List<Inline> CreateLinkIfNotNull(String value, String end = null, RoutedEventHandler handler = null, 
            object datacontext = null, ToolTip tip = null)
        {
            var inlines = new List<Inline>();
        ...
        protected Block CreateHeaderParagraph(string text, string secondaryText)
        {
            ...
            var header = new Paragraph
            {
                Background = UserSettings.Settings.DarkScheme?LighterBrush:DarkerBrush,
                Foreground = (Brush)Application.Current.Resources["ThemeTextBackgroundBrush"],
                FontSize = document.FontSize * 1.3
            };
