	...
	public partial class CustomCombatList : UserControl
    {
		...
		private void CreateCurrentPlayerView()
		{
           ...
           foreach (var ch in _CombatState.CombatList)
           {
            ...
            Unloaded += new RoutedEventHandler(CustomCombatList_Unloaded);
		}
        ...
        private void CombatListItemGrid_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
