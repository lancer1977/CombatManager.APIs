...
using CombatManager.Base;
using CombatManager.Base.DB;
...
namespace CombatManager.WPF7
{
    public static class UICharacterActionHandler
    {
        ...
        private static void HandleSave(ActionData data)
        {
            ...
            {
                BaseMonster.SaveType st;
                switch (data.Subtype)
                {
                    case "Fort":

                        st = BaseMonster.SaveType.Fort;
                        break;
                    case "Ref":

                        st = BaseMonster.SaveType.Ref;
                        break;
                    case "Will":
                    default:
                        st = BaseMonster.SaveType.Will;
                        break;
                }
