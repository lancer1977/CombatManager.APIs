namespace CombatManager.Utilities
{
    ...
    {
        public static void ToTupleList<T, TU>(this Dictionary<T, TU> source, List<Tuple<T, TU>> outputList)
        {
            outputList.Clear();

            foreach (var kv in source)
            {
                outputList.Add(new Tuple<T, TU>(kv.Key, kv.Value));
            }
        }

        public static void ToTupleList<T, TU>(this Dictionary<T, TU> source, ObservableCollection<Tuple<T, TU>> outputList)
        {
            outputList.Clear();
        ...
        public static void UpdateFromTupleList<T, TU>(this Dictionary<T, TU> target, List<Tuple<T, TU>> source)
        {
            target.Clear();
        ...
        public static void UpdateFromTupleList<T, TU>(this Dictionary<T, TU> target, ObservableCollection<Tuple<T, TU>> source)
        {
            target.Clear();
            foreach (var t in source)
            {
    ...
    public static class CmTupleUtils
    {
        ...
        public static List<string> ToStringList<T, TU>(this (T, TU) tuple)
        {
            return new List<string>() { tuple.Item1.ToString(), tuple.Item2.ToString()};

        }
        public static List<string> ToStringList<T, TU, TV>(this (T, TU, TV) tuple)
        {
            return new List<string>() { tuple.Item1.ToString(), tuple.Item2.ToString(), tuple.Item3.ToString()};

        }
        public static List<string> ToStringList<T, TU, TV, TW>(this (T, TU, TV, TW) tuple)
        {
            return new List<string>() { tuple.Item1.ToString(), tuple.Item2.ToString(), tuple.Item3.ToString(), tuple.Item4.ToString()};

        }
        public static List<string> ToStringList<T, TU, TV, TW, TX>(this (T, TU, TV, TW, TX) tuple)
        {
        ...
        public static List<string> ToStringList<T, TU, TV, TW, TX, TY>(this (T, TU, TV, TW, TX, TY) tuple)
        {
