...
namespace CombatManager.Personalization
{
    ...
    {
        static Dictionary<string, List<uint>> _recentColors;
        ...
        static void SaveColors()
        {
            ...
            foreach (var kv in _recentColors)
            {
        ...
        {
            _recentColors = new Dictionary<string, List<uint>>();
            ...
            if (cle != null)
            {
                ...
                {
                    _recentColors[cl.Name] = cl.Colors;
                }
            }
