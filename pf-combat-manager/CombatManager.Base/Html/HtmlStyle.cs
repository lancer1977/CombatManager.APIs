...
namespace CombatManager.Html
{
    ...
    public class HtmlSize : IEquatable<HtmlSize>
    {
        ...
        public static HtmlSize AutoSize => new(type: Auto);


        public static HtmlSize InheritSize => new(type: Inherit);
    ...
    {
        private HtmlSize _width;
        private HtmlSize _height;

        public HtmlSize Width
        {
            get => _width;
            set => _width = value.CopyDefault();
        }
        public HtmlSize Height
        {
            get => _height;
            set => _height = value.CopyDefault();
        }
    ...
    public abstract class BoxStyle : HtmlStyle
    {
        ...
        {
            get => _top;
            set => _top = value.CopyDefault();
        }
        HtmlSize Bottom
        {
            get => _bottom;
            set => _bottom = value.CopyDefault();
        }
        HtmlSize Left
        {
            get => _left;
            set => _left = value.CopyDefault();
        }
        HtmlSize Right
        {
            get => _right;
            set => _right = value.CopyDefault();
        }
        ...
        public virtual string EqualStyle => Name;
