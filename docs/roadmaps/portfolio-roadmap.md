# rpg-combat-manager.apis portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 9
- Files changed (90 days): 1008
- Last signal: 5ce982a (4 days ago)
- Top modified areas: pf-combat-manager(985);docs(8);00_agile(6);samples(2);Readme(1);README.md(1)
- Notes: clean_at_scan
...
- [ ] Document owner and intent for area: pf-combat-manager(985)
